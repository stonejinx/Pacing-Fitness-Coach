...
import 'package:running_coach/models/log_file_manager.dart';
import 'package:running_coach/models/wearable_connector.dart';
import 'package:running_coach/router.dart';
import 'package:running_coach/view_models/sensor_recorder_provider.dart';
import 'package:running_coach/widgets/app_banner.dart';
import 'package:running_coach/widgets/global_app_banner_overlay.dart';
      ...
      builder: (context) => PlatformTheme(
        ...
        cupertinoLightTheme: const CupertinoThemeData(
          ...
          textTheme: CupertinoTextThemeData(
            ...
            navTitleTextStyle: TextStyle(color: Colors.blue),
            navLargeTitleTextStyle: TextStyle(color: Colors.blue),
            navActionTextStyle: TextStyle(color: Colors.blue),
